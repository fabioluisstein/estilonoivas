		  ...
		  columns: [	
			...
			{ "data": 'id',
				...
				render: function ( data, type, row) {	 
					return  '<td class="text-right py-0 align-middle"> <div class="btn-group btn-group-sm"> <a href="/baixarArquivoPagamento/'+row.id+'" class="btn btn-info"><i class="fas fa-image"></i></a> </div> </td>';
				}
		    },
