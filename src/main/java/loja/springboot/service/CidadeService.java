...
public class CidadeService {
	...
	private String[] cols = {"id" , "nome", "estado", "quantidadeCliente"};
	
	public Map<String, Object> execute(CidadeRepository repository, HttpServletRequest request) {
		...
		Page<listTodasCidades> page = queryBy(search, repository, pageable);
