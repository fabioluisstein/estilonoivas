...
public class ProdutoDataTablesService {

	private String[] cols = {
		"id", "fornecedor", "categoria", "cor", "tamanho", "data_compra", "valor"
	};  
	 
	public Map<String, Object> execute(ProdutoRepository repository, HttpServletRequest request) {
		...
		Page<listTodosProdutos> page = queryBy(search, repository, pageable);
