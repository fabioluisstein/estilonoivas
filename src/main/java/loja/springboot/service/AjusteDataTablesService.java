...
public class AjusteDataTablesService {

	private String[] cols = {
		"id","locacao", "produto", "tipo", "cor", "tamanho", "cliente","status","liberacao"
	};
	
	public Map<String, Object> execute(LocacaoProdutoRepository repository, HttpServletRequest request) {
		...
		Page<listLocacaoProduto> page = queryBy(search, repository, pageable);
