...
public class ClienteDataTablesService {

	private String[] cols = {
		"id", "nome", "telefone", "whats", "cpf", "cidade"
	};
	
	public Map<String, Object> execute(ClienteRepository repository, HttpServletRequest request) {
		...
		Page<listTodosClientes> page = queryBy(search, repository, pageable);
