...
public class EstadoService {
	...
	private String[] cols = {"id" , "nome", "uf"};
	
	public Map<String, Object> execute(EstadoRepository repository, HttpServletRequest request) {
		...
		Page<listTodosEstados> page = queryBy(search, repository, pageable);
